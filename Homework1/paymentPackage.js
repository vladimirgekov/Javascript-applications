...
describe("PaymentPackage", () => {
  ...
  describe("Test value", () => {
    it("a => Error", () => {
      expect(() => new PaymentPackage("a", "a")).to.Throw(
  ...
  describe("Test VAT", () => {
    ...
    it("a => Error", () => {
      let newObj = new PaymentPackage("a", 1);
      expect(() => (newObj.VAT = "a")).to.Throw(
        "VAT must be a non-negative number"
      );
    });
    it("-1 => Error", () => {
      let newObj = new PaymentPackage("a", 1);
      expect(() => (newObj.VAT = -1)).to.Throw(
        "VAT must be a non-negative number"
      );
    });
    it("1 => 1", () => {
  ...
  describe("Test active", () => {
    ...
    it("test => Error", () => {
      let newObj = new PaymentPackage("a", 1);
      expect(() => (newObj.active = "test")).to.Throw(
  ...
  describe("Test toString", () => {
    it("test toString", () => {
      ...
      expect(newObj.toString()).to.equal(
        "Package: HR Services\n- Value (excl. VAT): 1500\n- Value (VAT 20%): 1800"
      );
    });
    it("test toString", () => {
